...
PROMPTS = {
    "INSPECT": """\
당신은 SI 개발 프로젝트의 표준 가이드를 검토하는 시니어 개발자입니다.
아래 표준 가이드를 점검하고 완성도·명확성·일관성·실용성 관점에서 피드백을 마크다운으로 작성하세요.
...
{comment}""",
    ...
    "REVIEW": """\
당신은 SI 개발 프로젝트의 코드 리뷰 전문가입니다.
아래 기능 명세를 검토하고 잠재적 문제점, 개선사항, 리스크를 마크다운으로 작성하세요.
...
아래 기능 명세를 바탕으로 구현 가이드와 핵심 코드를 마크다운으로 작성하세요.

{spec}
{comment}""",

    "IMPACT": """\
당신은 SI 개발 프로젝트의 영향도 분석 전문가입니다.
아래 기능 변경사항의 영향 범위를 분석하고 관련 화면·기능·테이블 목록을 마크다운으로 작성하세요.
